...
#url links
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'https://instantlinks.in')
...
FILE_FORWARD = environ.get('FILE_FORWARD',"https://t.me/+yxZoqRT1QNM1YWJl")
MSG_ALRT = environ.get('MSG_ALRT', '𝑪𝑯𝑬𝑪𝑲 & 𝑻𝑹𝒀 𝑨𝑳𝑳 𝑴𝒀 𝑭𝑬𝑨𝑻𝑼𝑹𝑬𝑺')
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', 0))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL',-1002123897389))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'naruto_english_dubbed_7')
